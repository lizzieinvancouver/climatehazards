...
## Copy of calcclimatemetrics_future.R but ssp585 -> ssp585 and .pdf -> ssp585.pdf
...
gtmn <- readfilestolist(paste("input/CMIP6_adjust/ssp585/GFDL-ESM4/GFDL-ESM4_tmn_", c(1976:2100), "_dly.fit", sep=""), c(1976:2100))
gtmx <- readfilestolist(paste("input/CMIP6_adjust/ssp585/GFDL-ESM4/GFDL-ESM4_tmx_", c(2020:2100), "_dly.fit", sep=""), c(2020:2100))

itmn <- readfilestolist(paste("input/CMIP6_adjust/ssp585/IPSL-CM6A-LR/IPSL-CM6A-LR_tmn_", c(1976:2100), "_dly.fit", sep=""), c(1976:2100))
itmx <- readfilestolist(paste("input/CMIP6_adjust/ssp585/IPSL-CM6A-LR/IPSL-CM6A-LR_tmx_", c(2020:2100), "_dly.fit", sep=""), c(2020:2100))

mhtmn <- readfilestolist(paste("input/CMIP6_adjust/ssp585/MPI-ESM1-2-HR/MPI-ESM1-2-HR_tmn_", c(1976:2100), "_dly.fit", sep=""), c(1976:2100))
mhtmx <- readfilestolist(paste("input/CMIP6_adjust/ssp585/MPI-ESM1-2-HR/MPI-ESM1-2-HR_tmx_", c(2020:2100), "_dly.fit", sep=""), c(2020:2100))
...
makefutureplots <- function(yearschange, minlist, maxlist, modelname){
	...
	pdf(paste0("graphs/futuretrends", modelname, "ssp585.pdf"), height=8, width=12)
...
pdf(paste0("graphs/futurevshistoricalGTMNssp585.pdf"), height=8, width=12)
invisible(lapply(plotshere, print))
dev.off()
