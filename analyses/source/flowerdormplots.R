...
pdf(paste0("graphs/phenofit/sims/extras/flowerendodorm/flowerendodormPinusMeanTemp", substr(whichsite, start = 1, stop = 2), ".pdf"), width=12, height=4)
par(mfrow=c(1,5))
dormlist <- list()
...
pdf(paste0("graphs/phenofit/sims/extras/flowerendodorm/flowerendodormPinus", substr(whichsite, start = 1, stop = 2), ".pdf"), width=12, height=4)
par(mfrow=c(1,5))
for (i in c(1:length(varchanges))){
...
pdf(paste0("graphs/phenofit/sims/extras/flowerendodorm/flowerendodormFagusMeanTemp", substr(whichsite, start = 1, stop = 2), ".pdf"), width=12, height=4)
par(mfrow=c(1,5))
dormlist <- list()
for (i in c(1:length(varchanges))){
    dfhere <- subset(check, sdtreat==varchanges[i])
...
pdf(paste0("graphs/phenofit/sims/extras/flowerendodorm/flowerendodormFagus", substr(whichsite, start = 1, stop = 2), ".pdf"), width=12, height=4)
par(mfrow=c(1,5))
for (i in c(1:length(varchanges))){
    plot(density(dormlist[[i]]), xlim=xlimnextplot, xlab="endodormancy result", main=paste0("Variance at ", varchanges[i]))
}
...
pdf(paste0("graphs/phenofit/sims/extras/flowerendodorm/flowerendodormQuercusMeanTemp", substr(whichsite, start = 1, stop = 2), ".pdf"), width=12, height=4)
par(mfrow=c(1,5))
dormlist <- list()
for (i in c(1:length(varchanges))){
    dfhere <- subset(check, sdtreat==varchanges[i])
...
pdf(paste0("graphs/phenofit/sims/extras/flowerendodorm/flowerendodormQuercus", substr(whichsite, start = 1, stop = 2), ".pdf"), width=12, height=4)
par(mfrow=c(1,5))
for (i in c(1:length(varchanges))){
    plot(density(dormlist[[i]]), xlim=xlimnextplot, xlab="endodormancy result", main=paste0("Variance at ", varchanges[i]))
}
