...
\item Confirm which Quercus species set we wanted to use, there are three:
\begin{itemize}
\item \verb|Quercus_robur_ADuputie_Chuine.species| -- {\bf model I used for new sims} and assume we agreed to use (should check notes/git commits to make sure I updated all sims)
...
\end{itemize}
\item Go through SD sims again and make sure we understand all of them. 
\end{itemize}
