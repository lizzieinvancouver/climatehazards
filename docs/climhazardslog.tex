...
\begin{itemize}
\item Are there any general take-home messages from our simulations? Answer: Endodormancy is key to predicting variance changes, and most variance changes also deal with frost damage. 
\item How much do historical trends inform or help our understanding of simulation results?  Answer: Not much for variance, but some for warming. 
...
4 June: We worked on climhazardresults.pdf! Including making predictions for mean warming x SD. \\
5 June: Met with I\~naki \\
6 June: Discussed predictions with Isabelle and Victor, including how important the endodormancy curves are to predictions. 
