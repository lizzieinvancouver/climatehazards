...
I worked on updating the endodormancy plots and leafindex plots that included freeze days and frost days (\verb|leafindex_decompose|). It's now mid-morning of my last day, so we'll see if I manage the fruit maturation plots also! 
