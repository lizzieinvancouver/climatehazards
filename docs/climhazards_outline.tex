...
\end{itemize}
\item Effects of increasing mean temperatures (summarized from results file, see above)
\item Fagus 
\begin{itemize}
...
\end{itemize}
\item Effects of increasing mean temperatures and shifts in variance (summarized from results file, see above)
\begin{itemize}
